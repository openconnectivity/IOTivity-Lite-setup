...
echo "mkdir -p ./iotivity-lite/port/windows/vs2015/x86/debug" >> gen.sh
echo "mkdir -p ./iotivity-lite/port/windows/vs2015/x86/release" >> gen.sh
echo "cp ./device_output/code/server_introspection.dat ./iotivity-lite/port/windows/vs2015/x86/debug/server_introspection.cbor" >> gen.sh
echo "cp ./device_output/code/server_introspection.dat ./iotivity-lite/port/windows/vs2015/x86/release/server_introspection.cbor" >> gen.sh
echo "#" >> gen.sh
